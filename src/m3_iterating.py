...
def run_test_count_negatives():
    ...
    # Test 6:
    expected = 1
    actual = count_negatives((1, 6 , -4, 0))
    print()
    ...
    # Test 7:
    expected = 4
    actual = count_negatives((-3, 2, 5, -5, -5, 3, 10, -100000000000000))
    print()
...
def run_test_count_short_ones():
    ...
    # Test 9:
    expected = 4
    seq = [[3, 2, 3, 4, 5], ['omae wa', 'mo shindeiru'], ['nani?!'], ['You are already dead'], ['What?']]
    actual = count_short_ones(seq)
    print()
    print('Test 7 expected:', expected)
    print('       actual:  ', actual)
